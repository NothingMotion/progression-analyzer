 ...
 */
public abstract class Hilt_AccountDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountDetailFragment() {
    super();
  }

  Hilt_AccountDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountDetailFragment_GeneratedInjector) this.generatedComponent()).injectAccountDetailFragment(UnsafeCasts.<AccountDetailFragment>unsafeCast(this));
    }
  }
