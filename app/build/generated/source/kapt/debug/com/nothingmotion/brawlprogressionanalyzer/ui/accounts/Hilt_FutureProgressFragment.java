...
import com.nothingmotion.brawlprogressionanalyzer.ui.future_account.FutureProgressFragment;
 ...
 */
public abstract class Hilt_FutureProgressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FutureProgressFragment() {
    super();
  }

  Hilt_FutureProgressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FutureProgressFragment_GeneratedInjector) this.generatedComponent()).injectFutureProgressFragment(UnsafeCasts.<FutureProgressFragment>unsafeCast(this));
    }
  }
